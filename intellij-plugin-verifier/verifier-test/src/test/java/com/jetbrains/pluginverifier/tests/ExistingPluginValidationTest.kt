...
class ExistingPluginValidationTest : BasePluginTest() {
  ...
  @Test
  fun `plugin is not built due to two different plugin problems and one problem level is remapped`() {
  ...
  private fun ideaPlugin(pluginId: String = "someid", pluginName: String = "someName", sinceBuild: String = "131.1") = """
    <id>$pluginId</id>
