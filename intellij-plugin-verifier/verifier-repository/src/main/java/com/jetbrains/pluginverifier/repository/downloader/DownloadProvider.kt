...
import com.jetbrains.pluginverifier.plugin.Striped
...
class DownloadProvider<in K : Any>(
  ...
  private val myNameGenerationLocks = Striped.lock(getConcurrencyLevel().coerceAtLeast(1))
  ...
  private fun saveDownloadedFileToFinalDestination(
    ...
    synchronized(myNameGenerationLocks.get(prefixAndSuffix)) {
