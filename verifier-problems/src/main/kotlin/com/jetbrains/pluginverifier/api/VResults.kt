...
sealed class VResult() {
   ...
   */
  class Nice(@SerializedName("plugin") val pluginDescriptor: PluginDescriptor,
             @SerializedName("ide") val ideDescriptor: IdeDescriptor,
             @SerializedName("overview") val overview: String) : VResult() {
   ...
   */
  class Problems(@SerializedName("plugin") val pluginDescriptor: PluginDescriptor,
                 @SerializedName("ide") val ideDescriptor: IdeDescriptor,
                 @SerializedName("overview") val overview: String,
                 @SerializedName("problems") val problems: Multimap<Problem, ProblemLocation>) : VResult() {
   ...
   */
  class BadPlugin(@SerializedName("plugin") val pluginDescriptor: PluginDescriptor,
                  @SerializedName("reason") val reason: String) : VResult() {
