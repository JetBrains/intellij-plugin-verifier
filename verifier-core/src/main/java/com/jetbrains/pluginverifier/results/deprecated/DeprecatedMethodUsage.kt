...
class DeprecatedMethodUsage(
  ...
  override val shortDescription
    get() = "Deprecated " + apiElement.methodOrConstructorWord + " ${apiElement.formatMethodLocation(FULL_HOST_NAME, SIMPLE_PARAM_CLASS_NAME, NO_RETURN_TYPE, NO_PARAMETER_NAMES)} invocation"

  override val fullDescription
    get() = buildString {
      append("Deprecated " + apiElement.methodOrConstructorWord + " ")
      ...
      if (deprecationInfo.forRemoval) {
        append(". This " + apiElement.methodOrConstructorWord + " will be removed in ")
