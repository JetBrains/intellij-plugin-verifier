...
data class MethodNotFoundProblem(val method: MethodReference,
  ...
  override val fullDescription = ("Method {0} contains an *{1}* instruction referencing an unresolved method {2}. " +
      "This can lead to **NoSuchMethodError** exception at runtime.").formatMessage(caller.formatMethodLocation(FULL_HOST_NAME, FULL_PARAM_CLASS_NAME, FULL_RETURN_TYPE_CLASS_NAME, WITH_PARAM_NAMES_IF_AVAILABLE), instruction, method)
