...
class InstanceAccessOfStaticFieldProblem(val field: FieldLocation,
  ...
  override val shortDescription = "Attempt to execute instance access instruction *{0}* on static field {1}".formatMessage(instruction, field)

  override val fullDescription = ("Method {0} has instance field access instruction *{1}* referencing static field {2}, " +
