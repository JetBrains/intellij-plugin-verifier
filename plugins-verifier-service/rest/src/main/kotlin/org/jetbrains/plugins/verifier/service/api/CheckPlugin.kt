...
class CheckPlugin(val host: String,
                  val ideFiles: List<File>,
                  val pluginFiles: List<File>,
                  val runnerParams: CheckPluginRunnerParams) : VerifierServiceApi<CheckPluginResults> {
  ...
  private fun execute(ideFiles: List<File>, pluginFiles: List<File>): CheckPluginResults {
    ...
    return waitCompletion<CheckPluginResults>(service, taskId)
  }
