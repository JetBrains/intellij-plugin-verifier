...
class DependencyTree(private val pluginProvider: PluginProvider, private val ideModulePredicate: IdeModulePredicate = NegativeIdeModulePredicate) {
  ...
  private val myDependencyCache: ConcurrentHashMap<Dependency, Dependency> = ConcurrentHashMap()

  private fun Dependency.intern(): Dependency {
    return myDependencyCache.computeIfAbsent(this, Function.identity())
  }
