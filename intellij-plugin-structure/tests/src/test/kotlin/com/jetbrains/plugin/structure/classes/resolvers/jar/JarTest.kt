...
class JarTest {
  ...
  fun `JAR is scanned`() {
    ...
    with(jar.serviceProviders) {
      ...
      assertEquals("com.intellij.platform.ijent.community.impl.nio.IjentNioFileSystemProvider", fileSystemProviderSp.single())
      ...
      assertEquals("com.intellij.openapi.application.impl.EdtCoroutineDispatcherFactory", mainDispatcherFactorySp.single())
